...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "xpinjection-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/xp-injection"
  #   chef.validation_client_name = "xp-injection-validator"
  #   chef.validation_key_path = ".chef/xp-injection-validator.pem"
  # end
end
